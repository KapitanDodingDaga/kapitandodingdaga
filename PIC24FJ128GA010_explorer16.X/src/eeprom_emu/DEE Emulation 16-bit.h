...
#define DATA_EE_BANKS       5                               // User can select the number of banks/page of EEPROM
#define DATA_EE_SIZE        ( 255 )                         // DO NOT  CHANGED THIS
#define DATA_EE_TOTAL_SIZE  (DATA_EE_BANKS * DATA_EE_SIZE)  //  this is the size of the eeprom(emulated using flash program memory)
...
// this functions are coded in assembly at "Flash Operations.s"
...
// this functions emulates the EEPROM in flash
